describe("StockFilterApp.Views.Doctor template rendering", function() {
    it('render by remote data', function (done) {
        var view = new StockFilterApp.Views.Doctor();
    ...
    it('render by collection instance', function() {
        var Doctors = new StockFilterApp.Collections.Doctors();
        Doctors.create({
            '_id': 1,
        ...
        var view = new StockFilterApp.Views.Doctor(Doctors);
        view.render();
